...
%%
start_id = 36; %1, 36; 333; 17638; %17427; %17600;
end_id = 36; %1, 36; 333; 17638; %17427; % 17600;
is_resubmit = 0;
...
for iprofile_hat = profile_range
    ...
    % profiles
    optimize_profile_soc = interp1(zsoi(1:soil_decom_num, 1), soc_mod(:, 4), wosis_layer_depth, 'pchip');
    ...
    try
        ...
        [~, ~, soc_mod] = ...
            ...
            input_vector_cwd, input_vector_litter1, input_vector_litter2, input_vector_litter3, ...
            altmax_current_profile, altmax_lastyear_profile, soil_temp_profile, soil_water_profile, xio, xin);
        mod_soc_mle = interp1(zsoi(1:soil_decom_num, 1), soc_mod(:, 4), wosis_layer_depth, 'pchip');
        % simulation by mean value
        [~, ~, soc_mod] = ...
            matrix_fun(para_summary_mean, nbedrock, sand_vector, npp_mean, ...
            input_vector_cwd, input_vector_litter1, input_vector_litter2, input_vector_litter3, ...
            altmax_current_profile, altmax_lastyear_profile, soil_temp_profile, soil_water_profile, xio, xin);
        mod_soc_mu = interp1(zsoi(1:soil_decom_num, 1), soc_mod(:, 4), wosis_layer_depth, 'pchip');
