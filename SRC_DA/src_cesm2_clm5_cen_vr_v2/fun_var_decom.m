function [carbon_input, cpools, cpools_layer, soc_layer, total_res_time, total_res_time_base, res_time_base_pools, t_scalar, w_scalar] = ...
    fun_var_decom(kp, is_default, nbedrock, sand_vector, npp_mean, ...
