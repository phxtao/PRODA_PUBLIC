...
parfor ibootstrap = start_id:end_id % cross_valid_id
    ...
    Var_Decom_Grid = {GridInfo, Var_Decom_Mean_Total, Var_Decom_Tau_Total};
    ...
    save_pathway = {[data_path, 'output_data/world_simulation_analyses/Var_Decom_Grid_NN_',  model_name, '_', nn_exp_name, '_control_test.mat'], ...
					[data_path, 'output_data/world_simulation_analyses/compontent_control_soc_total_stock_',  model_name, '_', nn_exp_name, '_control_test.mat']};
    save_var_namelist = {'Var_Decom_Grid', 'global_stock'};
    
    save_var = {Var_Decom_Grid, global_stock};
