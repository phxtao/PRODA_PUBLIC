%clear all;
%close all;
function a_out = a_matrix(fl1s1, fl2s1, fl3s2, fs1s2, fs1s3, fs2s1, fs2s3, fs3s1, fcwdl2, sand_vector)
...
%         a_ma_vr((3-1)*nlevdecomp+j,(1-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(9))*pathfrac_decomp_cascade(9);
%         a_ma_vr((4-1)*nlevdecomp+j,(1-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(10))*pathfrac_decomp_cascade(10);
%         a_ma_vr((5-1)*nlevdecomp+j,(2-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(1))*pathfrac_decomp_cascade(1);
%         a_ma_vr((5-1)*nlevdecomp+j,(3-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(2))*pathfrac_decomp_cascade(2);
%         a_ma_vr((5-1)*nlevdecomp+j,(6-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(6))*pathfrac_decomp_cascade(6);
%         a_ma_vr((5-1)*nlevdecomp+j,(7-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(8))*pathfrac_decomp_cascade(8);
%         a_ma_vr((6-1)*nlevdecomp+j,(4-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(3))*pathfrac_decomp_cascade(3);
%         a_ma_vr((6-1)*nlevdecomp+j,(5-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(4))*pathfrac_decomp_cascade(4);
%         a_ma_vr((7-1)*nlevdecomp+j,(5-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(5))*pathfrac_decomp_cascade(5);
%         a_ma_vr((7-1)*nlevdecomp+j,(6-1)*nlevdecomp+j) = (1.0-rf_decomp_cascade(7))*pathfrac_decomp_cascade(7);
    end
    a_out = a_ma_vr;
else
    pathfrac_decomp_cascade =[1, 1, 1, fs1s2, fs1s3, fs2s1, fs2s3, 1, fcwdl2, fcwdl3];
