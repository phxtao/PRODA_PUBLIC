...
parfor ibootstrap = 1:10
    ...
    Var_Decom_Grid = {GridInfo, Var_Decom_Mean_Total, Var_Decom_Tau_Total, ...
        bulk_process_A, bulk_process_K, bulk_process_Xi, bulk_process_V, bulk_process_I, bulk_process_NPP};
    ...
    %     save([data_path, 'output_data/world_simulation_analyses/marginal_sensitivity_proda_', process_manage_list{process_id}, '_', model_name, '_', nn_exp_name, '.mat'], 'Var_Decom_Grid');
